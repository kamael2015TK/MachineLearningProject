...
from crossvalidation_regression import *
#run file reader we will get X and lables
from file_reader import *
from toolbox_02450 import bmplot
...
y = standardizedData[:, targetFeatureIndex]
N, M = X.shape
del attributeNames[targetFeatureIndex]
...
for train_index, test_index in CV.split(X):
    ...
    X_test = X[test_index,:]
    y_test = y[test_index]
    internal_cross_validation = len(X_train)
